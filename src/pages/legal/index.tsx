...
const DOCS: Record<string, LegalDoc> = {
  privacy: {
    title: "隐私政策",
    intro:
      "沃天澜非常重视您的个人信息保护。本政策说明我们收集哪些信息、如何使用与保护它们。使用本小程序即表示您理解并同意本政策。",
    sections: [
      {
        h: "一、我们收集的信息",
        paras: [
  ...
  terms: {
    title: "用户协议",
    intro:
      "欢迎使用沃天澜。本协议是您与沃天澜之间关于使用本小程序服务所订立的契约，请在使用前仔细阅读。",
    sections: [
      {
        h: "一、服务说明",
        paras: [
          "1. 沃天澜是一款西班牙语词汇学习工具，提供基于 5D 学习法的单词学习、间隔复习、学习统计等功能。",
          "2. 词库内容由沃天澜整理制作，仅供参考学习使用，不构成任何专业建议。",
        ],
      },
      {
        h: "二、账号与登录",
      ...
      },
      {
        h: "五、知识产权",
        paras: [
          "本小程序的词库内容、界面设计、程序代码及相关知识产权均归沃天澜所有，未经书面许可不得转载或用于商业用途。",
        ],
      },
      {
        h: "六、免责声明",
  ...
  about: {
    title: "关于沃天澜",
    intro:
      "沃天澜是一款面向中文母语者的西班牙语主动词汇学习工具，覆盖 Starter 到 B2 共 4505 个高频词条。",
    sections: [
      {
        h: "5D 学习法",
        paras: [
